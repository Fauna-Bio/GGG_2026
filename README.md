...
The calculator may be found at https://poweranalysis-fb.streamlit.app. The source code for the calculator is included in this repository; the Streamlit interface links to the repository https://github.com/gennadygorin/poweranalysis. 
